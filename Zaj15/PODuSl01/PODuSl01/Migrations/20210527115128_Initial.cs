...
namespace PODuSl01.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK__stocks__E68284D3FFB00F59", x => new { x.store_id, x.product_id });
            //        table.ForeignKey(
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK__order_it__837942D46AF1093B", x => new { x.order_id, x.item_id });
            //        table.ForeignKey(
            ...
            //migrationBuilder.CreateIndex(
            //    name: "UQ__staffs__AB6E6164AB4DC9C8",
            //    schema: "sales",
            //    table: "staffs",
            //    column: "email",
            //    unique: true);
